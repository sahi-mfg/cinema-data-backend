# %%
from cinema_data_sdk import film_client, film_config

config = film_config.MovieConfig(
    movie_base_url="https://cinema-data-backend.onrender.com"
)
client = film_client.MovieClient(config)
